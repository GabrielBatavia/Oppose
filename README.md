...
Sprint 1 added the Oppose app shell, theme tokens, navigation stubs, core components, mock data, service boundaries, and asset registration. Sprint 2 should implement the onboarding flow in full.
